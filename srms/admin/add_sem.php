	...
	<div id="wrapper">
		...
		<section>
			<div class="container">
				...
				<!--Default Form-->
				<div class="hr-title hr-long center"><abbr>ADD NEW SEMESTER</abbr> </div>
				<div class="row">
					<div class="col-md-10 col-md-offset-1">
						<form action="semadded.php" method="post">
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="upper" for="name">ENTER THE SEMESTER</label>
										<input type="text" class="form-control required" name="sem" required="required" placeholder="ENTER SEMESTER NAME">
									</div>
								</div>
							</div>
							<div class="row">
