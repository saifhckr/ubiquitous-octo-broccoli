...
$(document).ready(function() {
    $("#Id").change(function ()
	{
		...
		$.ajax({url: "xyz.php",type: "POST",data:
		{x:a}, 
		success: function(data){
        $("#details_fetch1").html(data);
    }});
...
$t=mysql_query("select teacher_id,t_id from teacher_login");
echo "<select id='Id'>";
...
echo "<option value='".$r['t_id']."'>".$r['teacher_id']."</option>";	
}
echo "</select><br>";

?>

<div id="details_fetch1"></div>
