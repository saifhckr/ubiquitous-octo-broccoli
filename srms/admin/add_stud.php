	...
	<div id="wrapper">
		...
		<section>
			<div class="container">
				...
				<!--Default Form-->
				<div class="hr-title hr-long center"><abbr>ADD NEW STUDENT ACCOUNT</abbr> </div>
				<div class="row">
					<div class="col-md-10 col-md-offset-1">
						<form action="add.php" method="post">
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="upper" for="name">STUDENT NAME</label>
										<input type="text" class="form-control required" name="name" required="required" placeholder="ENTER STUDENT NAME">
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="upper" for="email">ID NO.</label>
										<input type="number" class="form-control required email" name="id" required="required" placeholder="ENTER STUDENT ID NUMBER">
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="upper" for="email">SEMESTER</label>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="upper" for="email">DATE OF BIRTH</label>
										<input type="date" class="form-control required email" name="dob" required="required" placeholder="ENTER DATE OF BIRTH">
									</div>
								</div>
							</div>
							<div class="row">
