	...
	<div id="wrapper">
		...
		<section>
			<div class="container">
				...
				<!--Default Form-->
				<div class="hr-title hr-long center"><abbr>ADD NEW TEACHER ACCOUNT</abbr> </div>
				<div class="row">
					<div class="col-md-10 col-md-offset-1">
						<form action="add_teach1.php" method="post">
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="upper" for="name">TEACHER NAME</label>
										<input type="text" class="form-control required" name="name" required="required" placeholder="ENTER TEACHER NAME" >
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="upper" for="email">TEACHER ID</label>
										<input type="email" class="form-control required email" name="id" required="required" placeholder="ENTER TEACHER ID NUMBER">
									</div>
								</div>
							</div>
							<div class="row">
