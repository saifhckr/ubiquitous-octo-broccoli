							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control required" name="name" required="required" value="<?php echo fetch_teach(); ?>">
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control required" name="id" required="required" value="<?php echo fetch_teach1(); ?>">
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control required" name="gender" required="required" value="<?php echo fetch_teach3(); ?>">
									</div>
								</div>
							</div>
							<div class="row">
