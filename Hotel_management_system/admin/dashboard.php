...
<nav class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
			...
			<li><a href="dashboard.php?option=add_new_admin">Add New Admin</a></li>
      ...
      <li><a href="dashboard.php?option=user_list">List of Users/Customers</a></li>
			<li><a href="dashboard.php?option=inquiries">Inquiries</a></li>
          </ul>
          </div>
...
else
{
  ...
  else if($opt=="add_new_user")
  {
	  include('add_new_user.php');
  }
    else if($opt=="inquiries")
  {
