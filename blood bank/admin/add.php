    ...
    <div id="wrapper">
        ...
        <section>
            <div class="container" >
                ...
                <div class="hr-title hr-long center"><abbr>ADD NEW CITY</abbr>
                </div>
                <div class="row">
                      ...
                      <div class="row">
        								<div class="col-md-6">
        									<div class="form-group">
        										...
        										<input type="hidden" class="form-control required" name="state1" value="<?php echo $_POST['state']; ?>">
        									</div>
        								</div>
        							</div>
        							<div class="row">
        								<div class="col-md-6">
        									<div class="form-group">
        										<label class="upper" for="name">City Name</label>
        										<input type="text" class="form-control required" name="city" required="required" placeholder="Enter City Name">
        									</div>
        								</div>
        							</div>
        							<div class="row">
