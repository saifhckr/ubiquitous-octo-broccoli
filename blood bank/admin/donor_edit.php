...
<body style="background-color:#ff0000 ;">
    ...
    <div id="wrapper">
        ...
        <section>
            <div class="container" >
              <div class="hr-title hr-long center"><abbr>UPDATE DONOR ACCOUNT</abbr>
              </div>
              <script>
              $(document).ready(function() {
                  $("#Id").change(function ()
              	{
              		...
              		$.ajax({url: "asd.php",type: "POST",data:
              		{x:a},
              ...
              $t=mysql_query("select sno,email from donor");
              echo "<select id='Id'>";
              ...
              echo "&nbsp;&nbsp;<option value='".$r['sno']."'>".$r['email']."</option>";
              }
              echo "</select><br>";
