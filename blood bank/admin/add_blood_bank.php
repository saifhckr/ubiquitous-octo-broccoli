    ...
    <div id="wrapper">
        ...
        <section>
            <div class="container" >
                ...
                <div class="hr-title hr-long center"><abbr>ADD NEW BLOOD BANK</abbr>
                </div>
                <div class="row">
        					<div class="col-md-10 col-md-offset-1">
        						<form action="bbadded.php" method="post">
        							<div class="row">
        								<div class="col-md-6">
        							...
        							<div class="row">
        								<div class="col-md-6">
        									<div class="form-group">
        										<label class="upper" for="email">ADDRESS</label>
        										<textarea class="form-control required email" name="address" required="required" placeholder="Enter Address"></textarea>
        									</div>
        								</div>
        							</div>
        							<div class="row">
        								<div class="col-md-6">
        									<div class="form-group">
        										<label class="upper" for="password">CONTACT</label>
        										<input type="text" class="form-control required" name="mobile" required="required" placeholder="Enter Contact Number">
        									</div>
        								</div>
        							</div>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            <label class="upper" for="password">CITY</label>
                            <input type="text" class="form-control required" name="city" required="required" placeholder="Enter City">
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            <label class="upper" for="password">STATE</label>
